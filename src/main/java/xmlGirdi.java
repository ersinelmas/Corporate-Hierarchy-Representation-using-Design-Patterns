...
//Örnek olarak xml dosyasından okuma yapma işlemini gerçekleştiren class
public class xmlGirdi implements GirdiStrategy{
    ...
    public void   girdiAl(String s) {
        ...
        if (!"xml".equals(dosyaTuru[1])) { System.out.println("HATA! Lütfen xml dosya türü giriniz!"); System.exit(0); } // sadece .xml dosya uzantısını okuyor
